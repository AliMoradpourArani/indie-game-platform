...
describe('submission state machine', () => {
  ...
  it('rejects illegal transitions (no boolean soup, no skipping review)', () => {
    const illegal: Array<[SubmissionState, SubmissionState]> = [
      ['DRAFT', 'APPROVED'],
      ['DRAFT', 'PUBLISHED'],
